 ...
 */
class ProductReviewsRelationshipByProductConcreteSkuPlugin extends AbstractPlugin implements ResourceRelationshipPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        $this->getFactory()
            ->createProductConcreteReviewResourceRelationshipExpander()
